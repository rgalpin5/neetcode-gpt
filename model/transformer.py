...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.norm_one = nn.LayerNorm(model_dim)
        self.norm_two = nn.LayerNorm(model_dim) 
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded = embedded + self.attention(self.norm_one(embedded))
        embedded = embedded + self.linear_network(self.norm_two(embedded))
